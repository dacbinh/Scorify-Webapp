...
import { GraduationCap, BookOpen, Users, Plus, Search, Filter, Edit, Trash2, Settings, LogOut, MoreVertical } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredClasses.length === 0 && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Hãy thử đổi từ khóa tìm kiếm hoặc tạo lớp mới</p>
            <button
              onClick={() => setShowCreateModal(true)}
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-2xl w-full p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Tạo lớp học mới</h2>
